...
//        i.isHide(true)
    ...
    lazy var rightImage:UIImageView = {
        let i = UIImageView(image: #imageLiteral(resourceName: "Rectangle 1724_1"))
...
//        i.constrainHeight(constant: 30)
    ...
    lazy var codeOrNumberTextField:UITextField = {
        let s = createMainTextFields(padding:80,place: "confirm Password", type: .default,secre: true)
    ...
    lazy var firstScrollButton = createButtons(image: #imageLiteral(resourceName: "Ellipse 128"))
    lazy var secondScrollButton = createButtons(image: #imageLiteral(resourceName: "Ellipse 129"))
    
    override func setupViews() {
        let ss = getStack(views: firstScrollButton,secondScrollButton, spacing: 8, distribution: .fillEqually, axis: .horizontal)
        
        addSubViews(views: LogoImage,backImage,titleLabel,soonLabel,vodafoneImage,fawryImage,doneButton,leftImage,rightImage,ss,choosePayLabel,codeOrNumberTextField)//,rightImage,leftImage,ss,choosePayLabel,codeOrNumberTextField,doneButton)

//        addSubViews(views: LogoImage,backImage,titleLabel,soonLabel,vodafoneImage,fawryImage,rightImage,leftImage,ss,choosePayLabel,codeOrNumberTextField,doneButton)
...
//            choosePayLabel.centerYAnchor.constraint(equalTo: centerYAnchor),
            ])
...
ss.anchor(top: vodafoneImage.bottomAnchor, leading: nil, bottom: nil, trailing: nil,padding: .init(top: 16, left: 32, bottom: 16, right: 32))
        codeOrNumberTextField.anchor(top: choosePayLabel.bottomAnchor, leading: leadingAnchor, bottom: nil, trailing: trailingAnchor,padding: .init(top: 16, left: 32, bottom: 16, right: 32))
