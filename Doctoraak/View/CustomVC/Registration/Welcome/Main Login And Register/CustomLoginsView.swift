...
//    override func setupViews() {
//
//        [ phoneNumberTextField, passwordTextField, createAccountButton,forgetPasswordButton].forEach({$0.addTarget(self, action: #selector(textFieldDidChange(text:)), for: .editingChanged)})
//
