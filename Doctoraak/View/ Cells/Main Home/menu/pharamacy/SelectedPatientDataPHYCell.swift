...
class SelectedPatientDataPHYCell: BaseCollectionCell {
    ...
    lazy var typeLabel = UILabel(text: "Type", font: .systemFont(ofSize: 16), textColor: .gray,textAlignment: .left)
    lazy var countLabel = UILabel(text: "3", font: .systemFont(ofSize: 16), textColor: .lightGray,textAlignment: .center)
