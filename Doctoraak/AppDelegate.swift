...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        window?.rootViewController =   UINavigationController(rootViewController: MainClinicWorkingHoursNotDoctorVC())//MainRegisterVC(indexx: 2))//MainClinicWorkingHoursNotDoctorVC())//MainClinicDataVC(indexx: 0, api_token: "", doctor_id: <#T##Int#>))//MainClinicDataVC(indexx: 0, api_token: "7vqKKNeUzsxA5cKJ943bhdbOpeIYGtx2gp3qo2ueaM", doctor_id: 33))//MainLoginsVC(indexx: 0))//MainVerificationVC(indexx: 1, isFromForgetPassw: false, phone: "00000000651", user_id: 33))//DoctorSecondRegisterVC(indexx: 0, male: "male", photo: #imageLiteral(resourceName: "Group 4142-6"), email: "a", name: "a", mobile: "", passowrd: ""))//MainRegisterVC(indexx: 2))//MainClinicDataVC(indexx: 0))//MainVerificationVC(indexx: 0, isFromForgetPassw: false, phone: "00000000010", user_id: 75))//DoctorRegisterVC(indexx: 0))//MainVerificationVC(indexx: 0, isFromForgetPassw: true, phone: ""))//)MainClinicDataVC(indexx: 0))//MainRegisterVC(indexx: 2))
