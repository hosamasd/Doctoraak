...
class DoctorServices {
    ...
    func updateClinic(clinic_id:Int,fees2:Int,fees:Int,lang:Double,latt:Double,phone:String,photo:UIImage?,city:Int,area:Int,api_token:String,waiting_time:Int,doctor_id:Int,completion:@escaping (MainDoctorClinicCreateModel?,Error?)->Void)  {
