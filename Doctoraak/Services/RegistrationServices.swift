...
class RegistrationServices {
    ...
    func mainRegister(index:Int,photo:UIImage,name:String,email:String,phone:String,password:String,insurance:[Int],delivery:Int,working_hours:[WorkModel] ,latt:String,lang:String,city:Int,area:Int,completion: @escaping (MainRegisterAllModel?, Error?) -> Void)  {
        let nn = index == 2 ? "lab_register" : index == 3 ? "radiology_register" : "pharmacy_register"
