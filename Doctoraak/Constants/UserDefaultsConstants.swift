...
class UserDefaultsConstants {
    ...
    static let indexForSMSCodeForSpecific="indexForSMSCodeForSpecific"
    
    static let mobileForAll="mobileForAll"
    static let nameForAll="nameForAll"
    static let emailForAll="emailForAll"
    static let secondMobikeForAll="secondMobikeForAll"
    static let passwordForAll="passwordForAll"
    ...
    static let isAllMainHomeObjectsFetchedPHY="isAllMainHomeObjectsFetchedPHY"
    static let isAllMainHomeObjectsFetchedRAD="isAllMainHomeObjectsFetchedRAD"
    static let isAllMainHomeObjectsFetchedLAB="isAllMainHomeObjectsFetchedLAB"
    static let isAllMainHomeObjectsFetchedDoctor="isAllMainHomeObjectsFetchedDoctor"
    static let isAllMainHomeObjectsFetchedMedicalCenterr="isAllMainHomeObjectsFetchedMedicalCenterr"
    ...
    static let medicalCenterRegisterImage = "medicalCenterRegisterImage"
    
    static let doctorRegisterName="doctorRegisterName"
    static let doctorRegisterEmail="doctorRegisterEmail"
    
    static let medicalCenterRegisterName="medicalCenterRegisterName"
    static let medicalCenterRegisterEmail="medicalCenterRegisterEmail"
    
    static let doctorRegisterMobile="doctorRegisterMobile"
    static let doctorRegisterSecondMobile="doctorRegisterSecondMobile"
    
    static let medicalCenterRegisterMobile="medicalCenterRegisterMobile"
    static let medicalCenterRegisterSecondMobile="medicalCenterRegisterSecondMobile"
    
    
    static let doctorRegisterPassword="doctorRegisterPassword"
    
    static let medicalCenterRegisterPassword="medicalCenterRegisterPassword"
    static let medicalCenterRegisterMale="medicalCenterRegisterMale"
    
    
    static let doctorRegisterIndee="doctorRegisterIndee"
    
    static let isDoctorSecondRegister="isDoctorSecondRegister"
    static let isMedicalCenterSecondRegister="isMedicalCenterSecondRegister"
    ...
    static let medicalCenterSecondRegisterSMSCode="medicalCenterSecondRegisterSMSCode"
    ...
    static let medicalCenterCurrentApiToken="medicalCenterCurrentApiToken"
    static let medicalCenterCurrentUSERID="medicalCenterCurrentUSERID"
    ...
    static let medicalCenterSecondRegisterUser_id = "medicalCenterSecondRegisterUser_id"
    ...
    static let isUserRegisterAndWaitForSMScODEDOC = "isUserRegisterAndWaitForSMScODEDOC"
    static let isUserRegisterAndWaitForSMScODEIndexDOC = "isUserRegisterAndWaitForSMScODEIndexDOC"
    
    static let isUserRegisterAndWaitForSMScODEOther = "isUserRegisterAndWaitForSMScODEOther"
    static let isUserRegisterAndWaitForSMScODEIndexOthers = "isUserRegisterAndWaitForSMScODEIndexOthers"
